        ...
        $output .= '<br>';   
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                if (isset($_POST['upload_form'])) {
                    ...
                    $filePathRelatives = $_POST['filePathRelatives'];
                    ...
                    if (isset($_FILES['document_upload']) && $_FILES['document_upload']['error'] == UPLOAD_ERR_OK) {
                        ...
                        $filePathRelatives = $this->getUploadedFiles($customer_id);
                        $this->saveDataToPreforma($filePathRelatives, $customer_id, $nombre_cliente, $tyme_credit, $credit, $tax_id, $email_address, $countryName, $city, $phone);     
                    }
