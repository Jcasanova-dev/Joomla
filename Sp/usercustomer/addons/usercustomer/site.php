...
session_start();
class SppagebuilderAddonUsercustomer extends SppagebuilderAddons
{
    public function render()
    {
        ...
        $output .= '<div>';
        $output .= '<br>';
        $output .= '<a href="https://mwt.one/index.php/en/new-user/created-users" class="btn btn-success">Volver</a>';
        $output .= '</div>';
        $output .= '</form>';
        $output .= '</div>';
