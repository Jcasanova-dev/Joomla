...
<?php
		...
		foreach($this->rows as &$row) {
			...
			$customer =isSameCustomer($row->order_number, $userId);
			if ($customer || is_null($customer_id)) {
?>
...
<?php if(!empty($number_invoice[0]->number_invoice)) { ?>
							...
							$filePathRelative2 = getUploadedFiles8($order_number, $number_invoice); ?>
							  <a href="#" onclick="mostrarArchivo2('<?php echo $filePathRelative2; ?>')">
...
<?php if (!empty($sapData['number_sap'])) { ?>
    <a class="hika_order_number" href="#">
...
<?php if (!empty($sapData['number_preforma'])) { 
	...
	?>
    <a href="#" onclick="mostrarArchivo3('<?php echo $filePathRelative3; ?>')">
...
<?php if(!empty($number_guia[0]->number_guia)) { ?>
							...
							<a href="#" onclick="mostrarArchivo4('<?php echo $filePathRelative4; ?>')">
