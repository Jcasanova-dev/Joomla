...
class SppagebuilderAddonShipping extends SppagebuilderAddons
{
    public function render()
    {
        ...
        $output .= '<div>';
        $output .= '<label for="company_name">Nombre de la Compañia</label>';
        ...
        $output .= '<div>';
        $output .= '<br>';
        $output .= '<label for="business_name">Razón Social</label>';
        $output .= '<input type="text" id="business_name" name="business_name"';
        $output .= 'oninput="validateCompanyRazon(this)" required>';
        $output .= '<span id="company_error" style="color: red;"></span>';
        $output .= '</div>';
        $output .= '<script>';
        $output .= 'function validateCompanyRazon(input) {';
        $output .= '    var pattern = /^[a-zA-Z ]+$/;';
        $output .= '    var errorMessage = "Solo se permiten letras en el campo Razón Social";';
        $output .= '    var errorElement = document.getElementById("company_error");';
        $output .= '    if (!pattern.test(input.value)) {';
        $output .= '        errorElement.textContent = errorMessage;';
        $output .= '    } else {';
        $output .= '        errorElement.textContent = "";';
        ...
        $output .= '<div>';
        $output .= '<br>';
            $output .= '<label for="tax_id">NIT</label>';
        ...
        $output .= '<div>';
        $output .= '<br>';
        $output .= '<label for="country">País</label>';
        ...
        $output .= '</div>';
            ...
            $output .= '<div>';
            $output .= '<br>';
            $output .= '<label for="additional">Actividades de la Compañia</label>';
        ...
        $output .= '<div>';
        $output .= '<br>';
        $output .= '<label for="file_upload">Contrato</label>';
        $output .= '<input type="file" id="file_upload" name="file_upload" accept=".pdf">';
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            try {
                ...
                $body = "<p>Nombre Compañia: $company</p>";
                $body .= "<p>Razón Social: $business</p>";
                $body .= "<p>Correo electrónico: $emailAddress</p>";
                $body .= "<p>NIT: $tax</p>";
                $body .= "<p>País: $countryName</p>";
                $body .= "<p>Ciudad: $city</p>";
                $body .= "<p>Número de teléfono: $phoneNumber</p>";
                $body .= "<p>Actividades Economicas: $additional</p>";
                $to2 = 'alejandro@muitowork.com';
                $to = 'alvaro@muitowork.com';
                $subject = "Solicitud Creacion de Cliente";
                $this->sendEmail($to, $to2,$subject, $body, $file);
        ...
        public function sendEmail($to, $to2,$subject, $body, $file) {
            try {
