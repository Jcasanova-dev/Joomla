...
class SppagebuilderAddonTracking extends SppagebuilderAddons
{
    public function render()
    {
        ...
        $status = $this->getStatus($order_number);
         if ($status == 'confirmed') {
            $output .= '<div style="display: flex; justify-content: space-around;">';
                $output .= '<div class="img-container"><img id="img1" class="img img1 active2" src="https://mwt.one/images/estatus/crever.png" alt="Imagen de estatus" title="Creacion/Credito"><p class="status-text">Creacion/Credito</p></div>';
                $output .= '<div class="img-container"><img id="img2" class="img img2 " src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
                $output .= '<div class="img-container"><img id="img3" class="img img3 " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
                $output .= '<div class="img-container"><img id="img4" class="img img4 " src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
                $output .= '<div class="img-container"><img id="img5" class="img img5 " src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                $output .= '<div class="img-container"><img id="img6" class="img img6 " src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
                $output .= '</div>';
                $output .= '<script>';
           ...
           if ($this->isSameCustomer($order_number, $userId)){
            ...
            if ($this->isSameCustomer($order_number, $userId)){
            $output .= '<div style="display: flex; justify-content: space-around;">';
                $output .= '<div class="img-container"><img id="img1" class="img img1 active" src="https://mwt.one/images/estatus/crever.png" alt="Imagen de estatus" title="Creacion/Credito"><p class="status-text">Creacion/Credito</p></div>';
                $output .= '<div class="img-container"><img id="img2" class="img img2 active2" src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
                $output .= '<div class="img-container"><img id="img3" class="img img3 " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
                $output .= '<div class="img-container"><img id="img4" class="img img4 " src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
                $output .= '<div class="img-container"><img id="img5" class="img img5 " src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                $output .= '<div class="img-container"><img id="img6" class="img img6 " src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
        ...
        $output .= '</script>';
            ...
            $output .= '<div style="display: flex; justify-content: space-around;">';
                $output .= '<div class="img-container"><img id="img1" class="img img1 active" src="https://mwt.one/images/estatus/crever.png" alt="Imagen de estatus" title="Creacion/Credito"><p class="status-text">Creacion/Credito</p></div>';
                $output .= '<div class="img-container"><img id="img2" class="img img2 active" src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
                $output .= '<div class="img-container"><img id="img3" class="img img3 active2 " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
                $output .= '<div class="img-container"><img id="img4" class="img img4 " src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
                $output .= '<div class="img-container"><img id="img5" class="img img5 " src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                $output .= '<div class="img-container"><img id="img6" class="img img6 " src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
                $output .= '</div>';
            ...
            if ($this->isSameCustomer($order_number, $userId)){
                ...
                $output .= '<div class="img-container"><img id="img1" class="img img1 active" src="https://mwt.one/images/estatus/crever.png" alt="Imagen de estatus" title="Creacion/Credito"><p class="status-text">Creacion/Credito</p></div>';
                $output .= '<div class="img-container"><img id="img2" class="img img2 active" src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
                $output .= '<div class="img-container"><img id="img3" class="img img3 active " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
                $output .= '<div class="img-container"><img id="img4" class="img img4 active2" src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
                $output .= '<div class="img-container"><img id="img5" class="img img5 " src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                $output .= '<div class="img-container"><img id="img6" class="img img6 " src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
                $output .= '</div>';
                $output .= '<script>';
            ...
            if ($this->isSameCustomer($order_number, $userId)){
                ...
                $output .= '<div class="img-container"><img id="img2" class="img img2 active" src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
                $output .= '<div class="img-container"><img id="img3" class="img img3 active " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
                $output .= '<div class="img-container"><img id="img4" class="img img4 active" src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
                $output .= '<div class="img-container"><img id="img5" class="img img5 active2" src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                $output .= '<div class="img-container"><img id="img6" class="img img6 " src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
                $output .= '</div>';
                $output .= '<script>';
            ...
            if ($this->isSameCustomer($order_number, $userId)){
                ...
                $output .= '<div class="img-container"><img id="img3" class="img img3 active " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
                $output .= '<div class="img-container"><img id="img4" class="img img4 active" src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
                $output .= '<div class="img-container"><img id="img5" class="img img5 active" src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                $output .= '<div class="img-container"><img id="img6" class="img img6 active2" src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
                $output .= '</div>';
                $output .= '<script>';
        ...
        ';
            ...
            $css .= '
                ...
                ' . $addon_id . ' .img.active3 {
                    border: 5px solid rgba(41, 41, 41);
                }
                ' . $addon_id . ' {
                    display: flex;
                    flex-wrap: wrap;
