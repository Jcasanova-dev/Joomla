    ...
    public function render()
    {
         ...
         if ($status == 'confirmed') {
           ...
           if ($this->isSameCustomer($order_number, $userId)){
            ...
            if ($titulo == 'Administrator'){
                ...
                $output .= '  document.getElementById("fechaf").max = startDate;';
                $output .= '}';
                $output .= '</script>';
                $output .= '<div>';
                $output .= '<br>';
                ...
                $output .= '</div>' ;
                $output .= '<br>';  
                $output .= '<div style="color: red;">El administrador completa esta sección.</div>';
                } 
        $output .= '</section>';
        $output .= '<script>';
        ...
        $output .= '</script>';
            ...
            if ($this->isSameCustomer($order_number, $userId)){
                ...
                $output .= '<br>';
                $operator = $this->getoperator($order_number);
                $output .= '<label for="operator">Gestor de carg</label>';
                $output .= '<input type="text" id="address_telephone" name="address_telephone" value="' . htmlspecialchars($operator['operator']) . '" readonly>';                      
                $output .= '</div>';
                $output .= '<div>';
                $output .= '<br>';
