...
class SppagebuilderAddonTracking extends SppagebuilderAddons
{
    public function render()
    {
        ...
        $status = $this->getStatus($order_number);
         if ($status == 'confirmed') {
            ...
            $output .= '<div class="img-container"><img class="img img1 active2" src="https://mwt.one/images/estatus/crever.png" alt="Imagen de estatus" title="Creacion/Credito"><p class="status-text">Creacion/Credito</p></div>';
            
            $output .= '<div class="img-container"><img class="img img2 " src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
            
            $output .= '<div class="img-container"><img class="img img3 " src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
            
            $output .= '<div class="img-container"><img class="img img4 " src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
            
            $output .= '<div class="img-container"><img class="img img5 " src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
            
            $output .= '<div class="img-container"><img class="img img6 " src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
            $output .= '</div>';       
             $output .= '<div>';
             $output .= '<br>';
            ...
            $output .= '</select>';
            $output .= '</div>';
             $filePathRelatives = $this->getUploadedFiles($order_number, $userId);
            ...
            $output .= '<div style="display: flex; justify-content: space-around;">';
            $output .= '<div class="img-container"><img class="img img1 active" src="https://mwt.one/images/estatus/crever.png" alt="Imagen de estatus" title="Creacion/Credito"><p class="status-text">Creacion/Credito</p></div>';
            
            $output .= '<div class="img-container"><img class="img img2 active2" src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
            ...
            $fecha = $this->getfechapro($order_number);
             if ($userId == '441' || $userId =='444'){
                ...
                $output .= '<input type="date" id="fechai" name="fechai" value="' . htmlspecialchars($fecha['fechai']) . '">';
                $output .= '</div>';
                $output .= '<div>';
                $output .= '<br>';
                $output .= '<label for="fechaf">Fecha Final de Producción:</label>';
                $output .= '<input type="date" id="fechaf" name="fechaf" value="' . htmlspecialchars($fecha['fechaf']) . '">';
                $output .= '</div>';
                $output .= '<div>';
                $output .= '<br>';
                $output .= '<input type="submit" name="producion_form" class="btn btn-primary" value="Enviar">';
                $output .= '</div>';
                $output .= '<script>';
                $output .= 'window.onload = function(){';
                $output .= '    document.getElementsByName("fechai")[0].onchange = function () {';
                $output .= '        var startDate = this.value;';
                $output .= '        document.getElementsByName("fechaf")[0].setAttribute("min", startDate);';
                $output .= '    };';
                $output .= '    document.getElementsByName("fechaf")[0].onchange = function () {';
                $output .= '        var endDate = this.value;';
                $output .= '        document.getElementsByName("fechai")[0].setAttribute("max", endDate);';
                $output .= '    };';
                $output .= '};';
                $output .= '</script>';
            }else{
        ...
        $output .= '</script>';
            ...
            $output .= '<div class="img-container"><img class="img img2 active" src="https://mwt.one/images/estatus/fab.png" alt="Imagen de estatus" title="Producción"><p class="status-text">Producción</p></div>';
            
            $output .= '<div class="img-container"><img class="img img3 active2" src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
            ...
            if ($userId == '441' || $userId == '444') {
                ...
                $output .= '<div>';
                $output .= '<br>';
                $output .= '<label for="address_selection">Dirección de Envío Registrada en la Orden:</label>';
                ...
                $output .= '<input type="text" id="valor" name="valor" value="' . htmlspecialchars($datos['order_shipping_price']) . '"';
                ...
                $output .= '<input type="file" id="document_upload3" name="document_upload3" >';
                $output .= '</div>';
                }
                $output .= '<br>';
                 $output .= '<div class="' . $addon_id . ' container">'; // Inicio del div contenedor
                ...
                $output .= '<div id="textAreaDiv" style="'.($operator['operator'] == 'Cliente' ? 'display: block;' : 'display: none;').'">';
                $output .= '<label for="details">Detalles:</label>';
                $output .= '<textarea id="details" name="details">'.htmlspecialchars($operator['details']).'</textarea>';
                $output .= '</div>';
                //script para opcion operador
                $output .= '<script>
                        var previousDetails = ""; // Variable para almacenar los detalles anteriores
            ...
            $output .= '</div>';
            $output .= '<input type="hidden" name="status" value="despacho">';
            $output .= '<div class="button-group">';
            $output .= '<br>';
            ...
            $output .= '<div class="img-container"><img class="img img3 active" src="https://mwt.one/images/estatus/prep.png" alt="Imagen de estatus4" title="Preparación"><p class="status-text">Preparación</p></div>';
            
            $output .= '<div class="img-container"><img class="img img4 active2" src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
             ...
             if ($methodo == 'Aereo') {
                if ($userId == '441'||$userId =='444'){
                    ...
                    */
                    ...
                    $output .= '    var pattern = /^[A-Za-z0-9-]+$/;';
                    $output .= '    var errorMessage = "Solo se permiten letras, números y el guion \'-\';";';
                    ...
                    $output .= '<input type="file" id="document_upload2" name="document_upload2" >';
                    $output .= '</div>';
                    
                    }               
                    $filePathRelatives2 = $this->getUploadedFiles9($order_number);
                    if (empty($filePathRelatives2)|| $filePathRelatives2[0]->certificado === NULL) {
                        $output .= '<div>';
                        $output .= '<br>';
                ...
                if ($userId == '441'||$userId =='444'){
                    ...
                    */
                    ...
                    $output .= '<script>';
                    $output .= 'function validateInvoiceNumber(input) {';
                    $output .= '    var pattern = /^[0-9-]+$/;'; // Modificada la expresión regular
            ...
            $output .= '<div class="img-container"><img class="img img4 active" src="https://mwt.one/images/estatus/despa.png" alt="Imagen de estatus5" title="Despacho"><p class="status-text">Despacho</p></div>';
            
            $output .= '<div class="img-container"><img class="img img5 active2" src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
            ...
            if ($operator['operator'] == 'Fabrica'){
                ...
                if ($userId == '441'||$userId =='444'){ 
                    ...
                    $output .= '<div>';
                    $state_parts2 = explode('_', $despacho['puerto_intermedio']);
                    if (!empty($state_parts2)) {
                        foreach ($state_parts2 as $part) {
                            if ($methodo == 'Aereo'){
                                $output .= '<br>';
                    ...
                    $output .= '<br>';
                    $output .= '<label for="fechaa">Fecha de Arribo:</label>';
                    $output .= '<input type="date" id="fechaa" name="fechaa" value="' . htmlspecialchars($despacho['fecha_arribo']) . '"min="' . date('Y-m-d') . '"readonly>';
                    $output .= '</div>';
                    $packs2 = $this->getUploadedFiles3($order_number);
                    $output .= '<div class="' . $addon_id . ' container">'; // Inicio del div contenedor
                            if (!empty($packs2)){
                ...
                $output .= '<div class="img-container"><img class="img img5 active" src="https://mwt.one/images/estatus/trans.png" alt="Imagen de estatus6" title="Transito"><p class="status-text">Transito</p></div>';
                
                $output .= '<div class="img-container"><img class="img img6 active2" src="https://mwt.one/images/estatus/compro.png" alt="Imagen de estatus6" title="Status/Pago"><p class="status-text">Status/Pago</p></div>';
                $output .= '</div>';
                $output .= '<section id="section1" style="display:none;">';
                $fecha = $this->getfechapro($order_number);
                $output .= '<div>';
                ...
                if ($operator['operator'] == 'Fabrica'){
                    ...
                    $output .= '<select id="tipo" name="tipo" onchange="handleTipoPagoChange(this)">';
                        ...
                        $output .= '<div id="additionalFieldsDiv" style="display: ' . ($tipo['tipo_pago'] == 'Completo' ? 'block' : 'none') . ';">';
                            ...
                            $output .= '<input type="number" id="tyme_credit" name="tyme_credit" value="' . htmlspecialchars($orderFullPrice) . '"readonly>';
                            $output .= '</div>';
                            $output .= '<div>';
                            $output .= '<br>';
                            ...
                            $output .= '<input type="date" id="fechap" name="fechap" value="' . htmlspecialchars($tipo['fecha_pago']) . '">';
                            $output .= '</div>';
                            $output .= '<div>';
                            $output .= '<br>';
                            $output .= '<label for="additional_info">Información adicional:</label>';
                        ...
                        if (!empty($tipos)) {
                            ...
                            $output .= '<input type="date" id="fechap2" name="fechap2" value="' . htmlspecialchars($tip['fecha_pago']) . '">';
                            $output .= '</div>';
                            $output .= '<div>';
                            $output .= '<br>';
                            ...
                            $output .= '<br>';
                            $output .= '<label for="fechap2">Fecha de Pago:</label>';
                            $output .= '<input type="date" id="fechap2" name="fechap2" value="' . htmlspecialchars($tipo['fecha_pago']) . '">';
                            $output .= '</div>';
                            $output .= '<div>';
                            $output .= '<br>';
                            $output .= '<label for="additional_info3">Información adicional:</label>';
                        ...
                        $output .= '<script>';
                        $output .= '$(document).ready(function() {';
                        $output .= '    var opcionesMetodoPago = "<option value=\'Consignacion\'>Consignación</option><option value=\'Nota\'>Nota Credito</option>";'; 
                        ...
                        $output .= '        nuevoCampo += \'<input type="date" class="fechas" name="fechas_nuevo[]">\';';
                        $output .= '        nuevoCampo += \'<br>\';';
        ...
        $output .= '</div>';
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                if (isset($_POST['upload_form'])) {
                    ...
                    count(array_filter($_FILES['document_upload_nuevo']['error'], function($err) { return $err == UPLOAD_ERR_OK; })) > 0)) {
                        ...
                        try {
                            ...
                            if (!empty($documentUpload3)){
                                $this->uploadAndSaveDocument10($documentUpload3, $order_number, $status);
                            }
                    ...
                    $documentUpload = isset($_FILES['document_upload']) && $_FILES['document_upload']['error'] == UPLOAD_ERR_OK ? $_FILES['document_upload']['tmp_name'] : null;
                    try {
    ...
    protected function uploadAndSaveDocument3($documentUpload, $order_number,$number_sap, $number_preforma,$status, $number_purchase, $userId)
    {
        try {
            ...
            if ($documentUpload && move_uploaded_file($documentUpload, $filePath)) {
                ...
                $this->saveDataToPreforma2(null, $order_number,$number_sap, $number_preforma, $number_purchase, $status, $userId);
            }
        } catch (Exception $e) {
            throw new Exception('Error uploading and saving document: ' . $e->getMessage());
        }
    ...
    protected function uploadAndSaveDocument10($documentUpload3, $order_number, $status)
    {
        try {
            ...
            if (move_uploaded_file($documentUpload3, $filePath)) {
                $this->saveDataToCotizacion($uploadDir . $filename, $order_number, $status);
            } else {
                throw new Exception('Error moving uploaded file');
            }
                echo '<script type="text/javascript">
   ...
   protected function saveDataToPreforma($filePath, $userId, $order_number, $number_purchase, $status, $customer_id)
   {
       ...
       try {
           // Obtener user_id y customer_id
           $query = $db->getQuery(true);
           $query->select($db->quoteName(array('user_id', 'customer_id')))
               ->from($db->quoteName('josmwt_hikashop_user'))
               ->where($db->quoteName('user_cms_id') . ' = ' . $db->quote($userId));
           $db->setQuery($query);
           $userData = $db->loadAssoc();
           if (!$userData || !isset($userData['user_id'], $userData['customer_id'])) {
               throw new Exception('No se encontró información válida para el usuario proporcionado');
           }
           $user_id = (int) $userData['user_id'];
           $query = $db->getQuery(true);
           $query->select($db->quoteName('order_number', 'number_purchase'))
           ...
           if ($existingOrderNumber) {
               throw new Exception('Ya existe un registro con el mismo Número de pedido');
           }
           $query = $db->getQuery(true);
           $columns = array('preformar', 'user_id', 'order_number', 'number_purchase');
           $values = array($db->quote($filePath), $user_id, $db->quote($order_number), $db->quote($number_purchase));
      ...
      protected function saveDataToPack($filePath, $order_number, $nomb_pack)
        ...
        protected function saveDataToCotizacion($filePath, $order_number, $status)
        {
            try {
                $db = JFactory::getDbo();
                $query = $db->getQuery(true);
