...
class SppagebuilderAddonReferencia extends SppagebuilderAddons
{
    public function render()
    {
        ...
        $output .= '</div>';
            ...
            $output .= '<div>';
            $output .= '<br>';
            $output .= '<label for="additional">Detalles de la Referencia</label>';
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            try {
                ...
                $subject = "Solicitud de Refrencia";
