...
<div id="hikashop_checkout_plg-order_<?php echo $this->step; ?>_<?php echo $this->module_position; ?>" data-checkout-step="<?php echo $this->step; ?>" data-checkout-pos="<?php echo $this->module_position; ?>" class="hikashop_checkout_order">
<?php } ?>
...
if(!empty($this->data)) {
?>
<fieldset class="hika_delivery_address_field hikashop_checkout_order_block">
