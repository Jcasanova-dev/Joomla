...
foreach ($columns as $c) {
	...
	?>
		<a class="checkout-button <?php echo $css_button . ' ' . $css_button_checkout; ?>" href="<?php echo $this->url_checkout; ?>" style="display: none;" onclick="if(this.disable) return false; this.disable = true;">
			<span><?php echo JText::_('PROCEED_TO_CHECKOUT'); ?></span>
		</a>

		<script>
			document.addEventListener('DOMContentLoaded', function() {
				const checkoutLink = document.querySelector('a.checkout-button');
				const quantityFields = document.querySelectorAll('.hikashop_product_quantity_field');

				// Función para verificar las cantidades en los inputs
				function checkQuantities() {
					let hasMultipleOf5 = false;
					...
					checkoutLink.style.display = hasMultipleOf5 ? 'inline-block' : 'none';
				}
				...
				// Verificar las cantidades iniciales al cargar la página
				checkQuantities();
			});
		</script>
	<?php
