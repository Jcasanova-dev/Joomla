						...
						<script>
							document.addEventListener('DOMContentLoaded', function() {
								...
								inputField.addEventListener('change', function() {
									...
									if (braNumber >= 33 && braNumber <= 37 || braNumber >= 45 && braNumber <= 47) {
										if (value % 5 !== 0) {
											alert('Debe ingresar múltiplos de 5 para BRA ' + braNumber);
											this.value = 0;
										}
									} else if (braNumber >= 38 && braNumber <= 44) {
										if (value % 10 !== 0) {
											alert('Debe ingresar múltiplos de 10 para BRA ' + braNumber);
											this.value = 0;
										}
									} else {
										alert('Valor de BRA no válido');
										this.value = 0;
									}
								});
							});
